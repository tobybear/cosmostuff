...
// tf: this define clashes with one further down
// I undefined it here as the other one is basically the same
...
// tf: these defines clash with previous defines further above
// I undefined them as the previous ones are the default ones available when using windows.h
...
//tf: I needed these for shared memory functions so I copied them from the Windows headers
#define INVALID_HANDLE_VALUE kNtInvalidHandleValue
#define PAGE_READWRITE kNtPageReadwrite
